...
This folder turns the project's Codex history into a reproducible, end-to-end workflow that students can copy for their own side projects. It focuses on transparency (what happened, why, and with what prompts) and reproducibility (what to do in what order).
